...
/**
 * Shows the Scenery on the left and right border of the game.
...
public class Scenery extends GameObject {
    ...
    /**
     * Creates the scenery with two borders left and right.
     *
     * @param gameView        The GameView object where the scenery will be displayed.
     * @param gamePlayManager The main gameplay logic.
     */

    public Scenery(GameView gameView, GamePlayManager gamePlayManager) {
