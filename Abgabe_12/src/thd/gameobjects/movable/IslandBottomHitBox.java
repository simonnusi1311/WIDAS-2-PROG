...
class IslandBottomHitBox extends CollidingGameObject implements ShiftableGameObject, ActivatableGameObject<JetFighter> {
    ...
    IslandBottomHitBox(GameView gameView, GamePlayManager gamePlayManager) {
