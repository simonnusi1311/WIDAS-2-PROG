...
class IslandTopHitBox extends CollidingGameObject implements ShiftableGameObject, ActivatableGameObject<JetFighter> {
    ...
    IslandTopHitBox(GameView gameView, GamePlayManager gamePlayManager) {
