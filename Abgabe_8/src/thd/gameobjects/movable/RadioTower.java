...
public class RadioTower extends GameObject implements ShiftableGameObject, ActivatableGameObject<JetFighter> {
    private final RadioTowerMovementPattern radioTowerMovementPattern;
    ...
    public RadioTower(GameView gameView, GamePlayManager gamePlayManager) {
        ...
        radioTowerMovementPattern = new RadioTowerMovementPattern();
        position.updateCoordinates(radioTowerMovementPattern.startPosition());
        speedInPixel = 1.3;
        size = 0.09;
        rotation = 0;
        width = 30;
