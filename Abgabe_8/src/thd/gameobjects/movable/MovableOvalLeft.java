...
public class MovableOvalLeft extends CollidingGameObject implements ShiftableGameObject, ActivatableGameObject<JetFighter> {
    ...
    public MovableOvalLeft(GameView gameView, GamePlayManager gamePlayManager) {
    ...
    public void addToCanvas() {
        gameView.addOvalToCanvas(position.getX(), position.getY(), width, height, 3, true, Color.GREEN.darker());
    }
